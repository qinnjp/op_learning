...
![1578397499511](F:\typora\1578397499511.png)
...
- 当写节点宕机后，后面跟的readhost也不提供服务，这时候standby的writehost就提供写服务，后面跟的readhost提供读服
...
- datahost其他配置
  ...
  - tempReadHostAvailable="1":  这个一主一从时（1个writehost，1个readhost时），可以开启这个参数，如果2个writehost，2个readhost时`<heartbeat>select user()</heartbeat> ` 监测心跳
